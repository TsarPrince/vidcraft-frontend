  ...
  return (
    <div className='flex items-center justify-center space-x-6 absolute bottom-12 left-1/2 -translate-x-1/2'>
      <button
        ...
        className={`px-28 py-14 flex items-center justify-center space-x-2 ${activeState === 'MergeVideo' ? 'bg-pink-500 shadow-pink-700' : 'bg-indigo-500 shadow-[#373ab3]'} text-white rounded-[2rem] text-xl shadow-[10px_10px_0_0] hover:translate-x-[10px] hover:translate-y-[10px] hover:shadow-none transition`}>
        ...
        <span className='flex-shrink-0'>Merge Videos</span>
      </button>
      <button
        onClick={() => setActiveState('GetMetadata')}
        className={`px-28 py-14 flex items-center justify-center space-x-2 ${activeState === 'GetMetadata' ? 'bg-pink-500 shadow-pink-700' : 'bg-indigo-500 shadow-[#373ab3]'} text-white rounded-[2rem] text-xl shadow-[10px_10px_0_0] hover:translate-x-[10px] hover:translate-y-[10px] hover:shadow-none transition`}>
        ...
        <span className='flex-shrink-0'>Get Metadata</span>
      </button>
      <button
        onClick={() => setActiveState('ViewBucket')}
        className={`px-28 py-14 flex items-center justify-center space-x-2 ${activeState === 'ViewBucket' ? 'bg-pink-500 shadow-pink-700' : 'bg-indigo-500 shadow-[#373ab3]'} text-white rounded-[2rem] text-xl shadow-[10px_10px_0_0] hover:translate-x-[10px] hover:translate-y-[10px] hover:shadow-none transition`}>
        ...
        <span className='flex-shrink-0'>View bucket</span>
      </button>
    </div>
  )
}
